export const PrivacyTerms = () => {
  return (
    <>
      <h2 className='text-center w-full text-lg font-semibold'>
      ...
      <p className='text-sm'>
        ...
        through the Service from a child without the consent of the childs
        parent or guardian as required by law, we will comply with applicable
        legal requirements to delete the information.
      </p>
      <h4 className='mt-4  font-semibold'>Changes to this Privacy Policy</h4>
      <p className='text-sm'>
